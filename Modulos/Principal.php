        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="Principal.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Home</a>
                    <a href="RetiroU.php" class="nav-item nav-link"><i class="fa fa-money-bill me-2"></i>Retiro</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $_SESSION['Saldo']; ?></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Tipo  -->
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $_SESSION['Tipo']; ?></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Numero  -->
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Numero de cuenta</p>
                                <h6 class="mb-0"><?php echo $_SESSION['Numero']; ?></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Fecha  -->
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $_SESSION['Fecha']; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($r['tipo'] == "Retiro") { ?>
                                            <td class="text-danger">-$<?php echo $r['cantidad']; ?></td>
                                        <?php } elseif ($r['tipo'] == "Deposito") { ?>
                                            <td class="text-success">+$<?php echo $r['cantidad']; ?></td>
                                        <?php  } ?>

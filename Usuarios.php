                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    ...
                                    <h5 class="mb-1"><?php echo $r['nombre']; ?></h5>
                                    <p>Numero: <?php echo $r['numero']; ?></p>
                                    <p class="mb-0">Saldo: <?php echo $r['saldo']; ?></p>
                                </div>
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="img/testimonial-2.jpg" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1"><?php echo $r['nombre']; ?></h5>
                                    <p><?php echo $r['numero']; ?></p>
                                    <p class="mb-0">Tipo de cuenta: <?php echo $r['tipo']; ?></p>
                                    <p class="mb-0">Contraseña: <?php echo $r['contrasena']; ?></p>
                                    <p class="mb-0">Estado: <?php echo $r['estado']; ?></p>
                                    <p class="mb-0">Fecha: <?php echo $r['fecha']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
